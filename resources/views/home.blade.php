									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                {{
                                                    number_format(((App\Models\invoices::where('Value_Status' , 1)->count()) / (App\Models\invoices::count())) * 100 , 2)
                                                }}%
                                            </span>
										</span>
									</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                {{
                                                    number_format(((App\Models\invoices::where('Value_Status' , 2)->count()) / (App\Models\invoices::count())) * 100 , 2)
                                                }}%
                                            </span>
										</span>
									</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                {{
                                                    number_format(((App\Models\invoices::where('Value_Status' , 3)->count()) / (App\Models\invoices::count())) * 100 , 2)
                                                }}%
                                            </span>
										</span>
									</div>
